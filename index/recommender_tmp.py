...
def predict():
	...
	# use cross validation here.. is there a score?

	test = df[df['creation_date'] > dt.now().date()]
	import pdb; pdb.set_trace()
	X_train_tokens = CountVectorizer().fit_transform(train['description')
	X_train_tfidf = TfidfTransformer().fit_transform(X_train_tokens)
